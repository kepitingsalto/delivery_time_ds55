...
def run_ml_app():
    ...
    total_onshift_partners = right.number_input("Jumlah kurir")
    total_busy_partners = left.number_input("Jumlah Kurir sedang mengantar")
    total_outstanding_orders = right.number_input("Jumlah Kurir standby")
